...
Route::group(['middleware' => ['auth', 'active']], function () {
    ...
    Route::get('category-submenu', [App\Http\Controllers\CategoryController::class, 'submenu'])->name('category.submenu');
    Route::get('category/delete-form/{id}', [App\Http\Controllers\CategoryController::class, 'deleteForm'])->name('category.delete-form');
