        ...
        @isset($type)
            <div class="col text-right">
                @if ($type == 'first')
                    ...
                    @endcan
                @endif
                <a class="btn btn-primary sectioncollapse btn-sm" data-toggle="collapse" href="#{{$type}}" aria-expanded="false" aria-controls="{{$type}}"><i class="text-white  fa fa-chevron-up" aria-hidden="true"></i></a>
            </div>
        @endisset 
    </div>  
</div>